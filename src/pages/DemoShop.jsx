...
const bakeryProducts = [
  { name: 'Chocolate Truffle Cake', price: 550, image: 'https://images.pexels.com/photos/132694/pexels-photo-132694.jpeg?auto=compress&cs=tinysrgb&w=400', desc: 'Rich Belgian chocolate, 1kg' },
  { name: 'Fresh Croissants', price: 120, image: 'https://images.pexels.com/photos/1070880/pexels-photo-1070880.jpeg?auto=compress&cs=tinysrgb&w=400', desc: 'Buttery flaky, pack of 4' },
  { name: 'Red Velvet Cupcake', price: 90, image: 'https://images.pexels.com/photos/1055272/pexels-photo-1055272.jpeg?auto=compress&cs=tinysrgb&w=400', desc: 'Cream cheese frosting' },
  { name: 'Artisan Bread Loaf', price: 180, image: 'https://images.pexels.com/photos/2098085/pexels-photo-2098085.jpeg?auto=compress&cs=tinysrgb&w=400', desc: 'Sourdough, 500g' },
  { name: 'Blueberry Muffin', price: 75, image: 'https://images.pexels.com/photos/1055272/pexels-photo-1055272.jpeg?auto=compress&cs=tinysrgb&w=400', desc: 'Fresh blueberries' },
  { name: 'Vanilla Pastry', price: 65, image: 'https://images.pexels.com/photos/132694/pexels-photo-132694.jpeg?auto=compress&cs=tinysrgb&w=400', desc: 'Classic vanilla cream' },
];
  ...
  return (
    <div className="min-h-screen bg-surface-50">
      ...
      <div className="sticky top-0 z-50 bg-white/90 backdrop-blur-xl border-b border-surface-200 px-4 sm:px-6 py-3 flex items-center justify-between">
        <button onClick={onBack} className="flex items-center gap-2 text-sm font-semibold text-surface-600 hover:text-surface-900 transition-colors">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="-mt-16 sm:-mt-20 mb-6 flex items-end gap-5">
          ...
          <div className="pb-2">
            <h1 className="text-2xl sm:text-3xl font-bold text-surface-900">Bakery Shop</h1>
        ...
        <p className="text-surface-600 text-base leading-relaxed mb-6 max-w-2xl">
          Fresh cakes, pastries, and artisan bread baked daily with love. Order now and get delivery within 2 hours!
        </p>
        ...
        {/* Products */}
        <h2 className="text-xl font-bold text-surface-900 mb-5">Our Products</h2>
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 pb-12">
          {bakeryProducts.map(product => (
            <div key={product.name} className="bg-white rounded-2xl shadow-card overflow-hidden group hover:shadow-elevated hover:-translate-y-1 transition-all duration-300">
              ...
              <div className="p-3 sm:p-4">
                ...
                <p className="text-xs text-surface-400 mt-0.5 truncate">{product.desc}</p>
                <p className="text-base font-bold text-primary-600 mt-1.5">₹{product.price}</p>
