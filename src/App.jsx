          ...
          {page !== 'admin' && shop && (
            <div className="mb-5 flex items-center justify-between bg-white rounded-xl px-4 py-3 shadow-soft border border-surface-200">
              <div className="flex items-center gap-2 text-sm text-surface-600">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M8 1.333a6.667 6.667 0 100 13.334A6.667 6.667 0 008 1.333zM8 6v2.667M8 10.667h.007" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/></svg>
                <span className="font-medium">Preview your shop as customers see it</span>
              </div>
              <Link
                to={`/shop/${shop.slug}`}
                target="_blank"
